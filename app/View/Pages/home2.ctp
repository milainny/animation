...
<div class="row mbottom">
	...
	<div class="span4">
		<div class="box">
			<h4><?=$this->Html->link(__('animationHierarchicalRoutingTitle'), array('controller'=>'pages', 'action'=>'hierarchicalRouting2'));?></h4>
...
<div class="row mbottom">
	...
	<div class="span4">
		<div class="box">
			<h4><?=$this->Html->link(__('animationThreeWayHandshakeTittle'), array('controller'=>'pages', 'action'=>'threewayHandshake2'));?></h4>
			<p><?=__('animationThreeWayHandshakeText')?></p>
		</div>
	</div>
	<div class="span4">
		<div class="box">
			<h4><?=$this->Html->link(__('animationAlohaTitle'), array('controller'=>'pages', 'action'=>'aloha2'));?></h4>
...
<div class="row">
	<div class="span4">
		<div class="box">
			<h4><?=$this->Html->link(__('animationEthernetTitle'), array('controller'=>'pages', 'action'=>'ethernet2'));?></h4>
			<p><?=__('animationEthernetText')?></p>
		</div>
	</div>
	<div class="span4">
		<div class="box">
			<h4><?=$this->Html->link(__('animationSequenceNumberTitle'), array('controller'=>'pages', 'action'=>'tcp2'));?></h4>
