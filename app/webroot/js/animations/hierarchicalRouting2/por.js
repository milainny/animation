var msg = {
	intro: {
		...
		msg3: 'Os protocolos que rodam dentro do AS são denominados <b>protocolos intra-AS</b>. Na internet os mais utilizados são o <b>RIP</b> (Routing Information Protocol) e o <b>OSPF</b> (Open Shortest Path First).'
	...
	tabelaRoteamento: {
		msg1: 'Suponha que o roteador 1b deseja alcançar a rede X. Como podemos observar ele pode chegar nela por meio de 1a ou 1c, mas pra isso 1b precisa saber dessa informação.',
		msg2: 'Temos aqui a tabela de roteamento do roteador 1b, que a princípio não possui informações referentes ao roteador 1c. Nela encontramos três colunas: <b>a sub-rede de destino, a identidade do roteador seguinte</b> ao longo do caminho de menor custo até a sub-rede de destino e o <b>número de saltos</b> (o número de sub-redes).',
		msg3: '',
		...
		msg5: 'O roteador 1b fica sabendo que agora há um novo caminho por meio do roteador 1c até a sub-rede x que é <b>menos custoso</b> do que o caminho pelo roteador 1a e então <b>atualiza sua tabela de roteamento</b>, conforme ilustrado abaixo.',
		msg6: 'Com essas informações, o roteador 1b sabe como alcançar pelo menor caminho a rede destino X. Assim, entendemos como é feita a comunicação <b>entre roteadores no mesmo AS</b> por meio do protocolo de roteamento intra-AS.'
	},
	interAS: {
		...
		msg5: 'No exemplo a seguir, temos <b>quatro ASs</b> (AS1, AS2, AS3 e AS4). Cada qual com seu próprio protocolo de roteamento, podendo ser diferente em cada AS. Temos também 1a, 2a, 3c, 4a e 4c como <b>roteadores de borda</b>.',
		msg56: 'Temos também 1a, 2a, 3c, 4a e 4c como <b>roteadores de borda</b>.',
...
var audios = new Array ("../../audio/rh1.mp3","../../audio/rh2.mp3","../../audio/rh3.mp3","../../audio/rh4.mp3","../../audio/rh5.mp3","../../audio/rh6.mp3","../../audio/rh7.mp3","../../audio/rh8.mp3","../../audio/rh9.mp3","../../audio/rh10.mp3","../../audio/rh11.mp3","../../audio/rh12.mp3","../../audio/rh13.mp3","../../audio/rh14.mp3","../../audio/rh15.mp3","../../audio/rh16.mp3","../../audio/rh16.mp3","../../audio/rh17.mp3","../../audio/rh18.mp3","../../audio/rh19.mp3","../../audio/rh20.mp3","../../audio/rh21.mp3","../../audio/rh22.mp3","../../audio/rh23.mp3","../../audio/rh24.mp3","../../audio/rh25.mp3","../../audio/rh26.mp3","../../audio/rh27.mp3","../../audio/rh28.mp3","../../audio/rh29.mp3","../../audio/rh30.mp3","../../audio/rh31.mp3","../../audio/rh32.mp3","../../audio/rh33.mp3","../../audio/rh34.mp3");
