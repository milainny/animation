init = function() {
	...
	blocks = new BlockAnimation(1,4);
		blocks.setAtributos(TcpConf1,msg.msg2); //TwhsIncrease
...
animator.setSteps(new ThreeWayhandShakeAnimation(TcpConf3, msg.msg7, true, false));

blocks = new BlockAnimation(1,5);
	blocks.setAtributos(TcpConf2,msg.msg7); //TwhsDecreaseLeft
animator.setSteps(blocks);

animator.setSteps(new TcpAnimation(TcpConf, msg.msg8, true));

	blocks = new BlockAnimation(1,4);
		blocks.setAtributos(TcpConf4,msg.msg8); //TwhsIncrease
	animator.setSteps(blocks);
	...
	blocks = new BlockAnimation(1,6);
		blocks.setAtributos(TcpConf6,msg.msg10); //TwhsDecrease
	animator.setSteps(blocks);

	animator.setSteps(new TcpAnimation(TcpConf, msg.msg11, true));

	blocks = new BlockAnimation(1,4);
		blocks.setAtributos(TcpConf7,msg.msg11); //TwhsIncrease
	animator.setSteps(blocks);
...
blocks = new BlockAnimation(1,5);
	blocks.setAtributos(TcpConf9,msg.msg14); //TwhsDecreaseLeft
animator.setSteps(blocks);

animator.setSteps(new TcpAnimation(TcpConf, msg.msg15, true));

blocks = new BlockAnimation(1,4);
	blocks.setAtributos(TcpConf7,msg.msg15); //TwhsIncrease
animator.setSteps(blocks);
...
blocks = new BlockAnimation(1,5);
	blocks.setAtributos(TcpConf9,msg.msg17); //TwhsDecreaseLeft
animator.setSteps(blocks);

animator.setSteps(new TcpAnimation(TcpConf, msg.msg18, true));

blocks = new BlockAnimation(1,4);
	blocks.setAtributos(TcpConf4,msg.msg18); //TwhsIncrease
animator.setSteps(blocks);
...
blocks = new BlockAnimation(1,6);
	blocks.setAtributos(TcpConf6,msg.msg19); //TwhsDecrease
animator.setSteps(blocks);
...
var MessageAnimationImgAndShine = function(pos, next, imgs) {
this.prototype = new Animation();
this.msgs = this.buildMsgs(pos);
this.prototype.persistent = false;
this.opacity = 0.5;
