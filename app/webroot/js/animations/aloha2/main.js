init = function() {
	...
	blocks = new BlockAnimation(2,1);
		blocks.setAtributos({"sx":240, "sy":300, "dx":240, "dy":400, "rotate": 90}, msg.msg3, true);
		blocks.setAtributos({"sx":240, "sy":400, "dx":400, "dy":400}, null, true);
	animator.setSteps(blocks);
	blocks = new BlockBackground(2);
	  blocks.setAtributos('aa',  msg.msg4, true, AlohaConf, false);
		blocks.setAtributos('aat', msg.msg4, false, AlohaTranConf, false); //AlohaAnimationTransition
	animator.setSteps(blocks);
	blocks = new BlockBackground(2);
		blocks.setAtributos('aa', msg.msg5, true, AlohaConf, false);
		blocks.setAtributos('aat', msg.msg5, false, AlohaTranConf, false); //AlohaAnimationTransition
	animator.setSteps(blocks);
	blocks = new BlockAnimation(2,3);
		blocks.setAtributos([{"sx":400, "sy":400, "dx":550, "dy":400},{"sx":540, "sy":300, "dx":540, "dy":400, "rotate": 90}], true, AlohaGarbeConf1);
		blocks.setAtributos([{"sx":540, "sy":400, "dx":540, "dy":500},{"sx":540, "sy":400, "dx":540, "dy":500, "rotate": 90}], true, AlohaGarbeConf1);
	animator.setSteps(blocks);
	animator.setSteps(new EmptyAnimation(msg.msg6));
	blocks = new BlockAnimation(6,3);
		blocks.setAtributos([{"sx":240, "sy":300, "dx":240, "dy":400, "rotate": 90}], true,AlohaConf);
		blocks.setAtributos([{"sx":240, "sy":400, "dx":540, "dy":400}], true,AlohaConf);
		blocks.setAtributos([{"sx":540, "sy":400, "dx":590, "dy":400},{"sx":540, "sy":400, "dx":540, "dy":300, "rotate": 90}],true,AlohaConf);
		...
		blocks.setAtributos([{"sx":840, "sy":400, "dx":840, "dy":300, "rotate": 90}], true,AlohaConf);
	animator.setSteps(blocks);
	animator.setSteps(new EmptyAnimation(msg.msg7));
	animator.setSteps(new EmptyAnimation(msg.msg8));
	blocks = new BlockAnimation(4,3);
		blocks.setAtributos([{"sx":540, "sy":300, "dx":540, "dy":400, "rotate": 90}], true, AlohaConf);
		blocks.setAtributos([{"sx":540, "sy":400, "dx":240, "dy":400},{"sx":540, "sy":400, "dx":840, "dy":400}],true,AlohaConf);
		blocks.setAtributos([{"sx":240, "sy":400, "dx":240, "dy":320, "rotate": 90},{"sx":840, "sy":400, "dx":840, "dy":300, "rotate": 90}],true,AlohaGarbeConf3);
		blocks.setAtributos([{"sx":240, "sy":320, "dx":130, "dy":320, "rotate": 0}],true,AlohaGarbeConf3);
	animator.setSteps(blocks);
 ...
 */
 ...
 function Animator2() {
 	...
 	window.requestAnimFrame = (function(callback) {
 		return window.requestAnimator2Frame || window.webkitRequestAnimator2Frame || window.mozRequestAnimator2Frame || window.oRequestAnimator2Frame || window.msRequestAnimator2Frame ||
 		function(callback) {
