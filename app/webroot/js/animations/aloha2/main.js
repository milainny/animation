init = function() {
	...
	blocks = new BlockAnimation(2,1);
		blocks.setAttributes({"sx":240, "sy":300, "dx":240, "dy":400, "rotate": 90}, msg.msg3, true);
	...
	blocks = new BlockAnimation(2,3);
		blocks.setAttributes([{"sx":400, "sy":400, "dx":550, "dy":400},{"sx":540, "sy":300, "dx":540, "dy":400, "rotate": 90}], true, AlohaGarbeConf1);
	...
	blocks = new BlockAnimation(6,3);
		blocks.setAttributes([{"sx":240, "sy":300, "dx":240, "dy":400, "rotate": 90}], true,AlohaConf);
