init = function() {
	...
	blocks = new BlockBackground(2);
		blocks.setAtributos('ra', "", true, AnimationConf); //RouterAnimation
		blocks.setAtributos('hma', msg.interAS.msg2, false, [ { //HtmlMessageAnimation
			"id": "text3",
			"dx": 210,
			"dy": 120,
			"size": 700,
	...
	//SESSOES BGP
	blocks = new BlockBackground(2);
		blocks.setAtributos('ra', "", true, AnimationConf2); //RouterAnimation
		blocks.setAtributos('ea', msg.sessaoBGP.msg1); //EmptyAnimation
	animator.setSteps(blocks);

//	animator.setStep(new EmptyAnimation(msg.sessaoBGP.msg2));

	blocks = new BlockBackground(2); 
		blocks.setAtributos('ra', msg.sessaoBGP.msg3, true, AnimationConf3); //RouterAnimation
		blocks.setAtributos('hma', null, false,[ { //HtmlMessageAnimation
			"id": "msg1",
			"dx": 325,
			"dy": 120,
			"size": 500,
	...
	blocks = new BlockBackground(2);
	blocks.setAtributos('ra', "", true, AnimationConf3); //RouterAnimation
	blocks.setAtributos('ea', msg.atributosBGP.msg1); //EmptyAnimation
	animator.setSteps(blocks);
