...
CloudAnimation.prototype.drawRouterTopIP = function(ctx) {
	...
	this.drawTexts(ctx, [{"content": "162.103.128.0", "style": "arial16Bold"}], {"x": 75, "y": 300});
	this.drawTexts(ctx, [{"content": "162.103.0.0", "style": "arial16Bold"}], {"x": 775, "y": 300});
};
...
BlockBackground.prototype.setAtributos = function(type,msgs,next,outros) {
	this.type.push(type);
	this.msgs.push(msgs);
	this.nexts.push(next);
